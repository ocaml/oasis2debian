...
(* OASIS_START *)
(* DO NOT EDIT (digest: cfdfa3a935428aa9f7c681ab16cd4dad) *)
(*
     ...
     package =
       {
          ...
          homepage = Some "http://oasis.forge.ocamlcore.org/oasis2debian";
          synopsis =
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("xstrp4",
                               Some (OASISVersion.VGreaterEqual "1.8"));
                           FindlibPackage
                             ("fileutils",
